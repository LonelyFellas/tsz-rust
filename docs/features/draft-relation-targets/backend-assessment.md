...
> **实现更新（2026-08-22）**：本文的发布方案评估已被
> [`implemented-stable-target-anchors.md`](./implemented-stable-target-anchors.md) 取代。
> 当前实现允许来源 publication 直接引用有效草稿 sense；本文保留为历史分析，不再作为发布规则。
