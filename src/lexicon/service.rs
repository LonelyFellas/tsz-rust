...
use crate::lexicon::{
    ...
    dto::{
        ...
        WordDefinitionV2, WordDetectionSnapshotSmartDictionaryV2, WordEntryKindV3, WordFormGroupV2,
        WordFormTypeV2, WordFormVariantV2, WordHeadwordsV2, WordPosFormsV2, WordPosMeaningsV2,
        WordPronunciationV2, WordRegionalVariantsV3, WordRelationV2, WordSenseV2, WordSenseV3,
        WordSentenceAssociationV2, WordSentenceLinkV2, WordSentenceV2,
    },
