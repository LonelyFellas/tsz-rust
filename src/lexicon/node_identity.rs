use crate::lexicon::dto::{Dialect, WordDefinitionV3};
...
pub(crate) fn definition_role(definition: &WordDefinitionV3) -> &'static str {
    match definition {
        WordDefinitionV3::ZhDefinition { .. } => "meanings.definition:zh:definition",
        WordDefinitionV3::ZhSentence { .. } => "meanings.definition:zh:sentence",
        WordDefinitionV3::EnDefinition { .. } => "meanings.definition:en:definition",
        WordDefinitionV3::EnSentence { .. } => "meanings.definition:en:sentence",
    }
}
