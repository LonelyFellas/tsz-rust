...
pub enum V3ValidationIssueCode {
    ...
    RelationPendingTargetUnresolved,
...
impl V3ValidationIssueCode {
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::RelationPendingTargetUnresolved => "relation_pending_target_unresolved",
    ...
    pub fn from_wire(value: &str) -> Option<Self> {
        Some(match value {
            ...
            "relation_pending_target_unresolved" => Self::RelationPendingTargetUnresolved,
